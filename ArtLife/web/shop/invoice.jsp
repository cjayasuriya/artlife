<%-- 
    Document   : invoice
    Created on : Mar 20, 2017, 9:13:21 AM
    Author     : chamal
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1>Thanks for your order, <%out.write(request.getSession().getAttribute("firstname").toString());%>!</h1>
                    <br/>
                    <p style="font-size: 20px;color: #34495e;">Your order is confirmed and we'll let you know when it's on the way.</p>
                    <a href="../shop/art-products.jsp">Continue shopping</a>
                    <hr>
                </div>
                <div class="col-md-12">
                    <div class="col-md-6">
