<%-- 
    Document   : order
    Created on : May 4, 2017, 3:16:18 PM
    Author     : chamal
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="orders.jsp">Orders</a></li>
                    <li class="active">Order #<%out.write(request.getParameter("orderId").toString());%></li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12"><br></div>
                        <%
                            ...
                            Pojos.Orders order = (Pojos.Orders) orderCriteria.uniqueResult();
                            if (order.getOrderStatus().getId() != 5 & order.getOrderStatus().getId() != 4) {
                        %>
                    <div class="col-md-12">
                        <h4>Continue processing this order</h4>
                    </div>
                    <div class="col-md-12">
                        <form action="../UpdateOrderStatusServlet" method="POST">
                            <input type="hidden" name="oid" value="<%=order.getId()%>">
                            <div class="col-md-2">  <label>Order status</label></div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select class="form-control" name="orderStatus" id="orderStatus">
                                        <option value="<%=order.getOrderStatus().getId()%>"><%=order.getOrderStatus().getName()%></option>
                                        <%
                                            try {
                                                for (Pojos.OrderStatus status : Classes.helpers.getAllOrderStatuses()) {
                                        %>
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="orderstatusmsg"/>
                                <br>
                            </div>       
                            <div class="col-md-3">
                                <input type="submit" id="edit-order-status-btn" class="btn btn-primary btn-block" name="edit-order_status-btn" value="Update order status"/>  
                            </div>
                        </form>
                    </div>
                    <div class="col-md-12"><br></div>
