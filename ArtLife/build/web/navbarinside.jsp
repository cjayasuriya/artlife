                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="../account/profile.jsp?name=<%out.write(request.getSession().getAttribute("firstname").toString().toLowerCase() + "." + request.getSession().getAttribute("lastname").toString().toLowerCase());%>"><span class="fa fa-cog"></span> Account</a></li> 
