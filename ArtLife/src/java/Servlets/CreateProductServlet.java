...
public class CreateProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             * Create a product
             */
            if (request.getParameter("create-product-btn").equals("Add new product")) {

                //Validation part
                if (!(request.getParameter("skucode").equals(null) | request.getParameter("productname").equals(null) | request.getParameter("productprice").equals(null) | request.getParameter("sellingprice").equals(null) | request.getParameter("qty").equals(null) | request.getParameter("shippingprice").equals(null))) {

                    Integer catgory, qty, uid;
                    ...
                    try {
                        ...
                        Pojos.Products product = new Products();
