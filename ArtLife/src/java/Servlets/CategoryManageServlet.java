...
public class CategoryManageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             * Create a category
             */
            if (request.getParameter("create-category-btn").equals("Add new category")) {

                //Validation of categoty name
                if (!(request.getParameter("categoryname").equals(null) | request.getParameter("categoryname").equals(" "))) {
                    ...
                    Pojos.Categories category = new Categories();
                    category.setParentid(parentId);
                    category.setName(categoryName);
                    category.setCategoryKey(categoryName.toLowerCase());
                    category.setMeta(metaJSONObject.toString());
                    category.setCuid(uid);
                    category.setUuid(uid);
                    ...
                    //Pass the error that category name cannot be emppty
                }
